...
//       );
//     });
//     this.product._initialDetailIds = detailsArray
//       .filter(d => d.id)
//       .map(d => d.id!);
...
// public save(): void {
//   console.log('🔍 فرم ولید؟', this.form.valid);

//   if (this.form.invalid) {
//     console.warn('❌ فرم نامعتبره، ذخیره قطع شد');
//     return;
//   }
...
//     ...this.product,  // 👈 مهم: id + _initialDetailIds + بقیه میاد
//     ...this.form.value,
//     image: finalImageUrls,
//     details: this.details.value
//   };

//   console.log('🚀 دیتای نهایی برای والد:', productData);
